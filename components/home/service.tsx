...
import { LoadingContext } from "../layouts/layout-main";
        ...
        >
            <main ref={contentRef} className="transform-container">
                <header className="w-[90%] mx-auto max-w-[1440px] py-[6rem] space-y-[6rem]">
                    ...
                    <div>
                        <h2 className="text-[15rem] font-anton-sc uppercase leading-[100%] text-[#146321]">
                            <TextReveal
                                splitType="chars"
                                direction="up"
                                duration={0.7}
...
> = ({ description, details, image, position, title, index }) => {
    return (
        <article
            className={`bg-inverse-1 flex h-screen ${position === "left" ? "flex-row-reverse" : "flex-row"
                }`}
        >
            ...
            <div className="w-[60%] p-[6rem] flex flex-col justify-between">
                <div className="space-y-4">
                    <h2 className="font-anton-sc uppercase flex flex-col leading-[100%] text-[6rem] text-[#146321]">
                        {title.map((t, i) => (
                            <TextReveal
                                splitType="chars"
                                direction="up"
